...
energy_data = pd.read_csv('PJME_hourly.csv')

# Data Exploration
# Display the first few rows of the dataset
print(PJME_hourly.head())

# Check data types and missing values
print(PJME_hourly.info())

# Summary statistics
print(PJME_hourly.describe())
...
plt.hist(PJME_hourly['Consumption'], bins=20, color='green', edgecolor='black')
...
mean_consumption = PJME_hourly['Consumption'].mean()
std_consumption = PJME_hourly['Consumption'].std()
...
max_consumption = PJME_hourly['Consumption'].max()
min_consumption = PJME_hourly['Consumption'].min()
...
correlation_matrix = PJME_hourly.corr()
...
# Load energy consumption data (replace 'PJME_hourly.csv' with your dataset file)
PJME_hourly = pd.read_csv('PJME_hourly.csv')
...
# Plot a time series of energy consumption
plt.figure(figsize=(12, 6))
plt.plot(PJME_hourly['Date'], PJME_hourly['Consumption'], label='Energy Consumption', color='blue')
plt.title('Energy Consumption Over Time')
plt.xlabel('Date')
plt.ylabel('Energy Consumption')
plt.legend()
...
# Plot a histogram of energy consumption
plt.figure(figsize=(8, 6))
sns.histplot(PJME_hourly['Consumption'], bins=20, color='green', kde=True)
...
sns.pairplot(PJME_hourly, diag_kind='kde')
plt.show()
